...
class Win211_Search_Plugin_Public {
	...
	public function enqueue_scripts() {
		...
		/* wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . '/php/211search_cities.php', array( 'jquery'), $this->version, false ); */
		/* wp_enqueue_script('citiesurl', plugin_dir_url('','win211-search-plugin') . 'win211-search-plugin/public/php/211search_cities.php'); */
		wp_enqueue_script( 'citiesurl', plugin_dir_url(__FILE__) . 'php/211search_cities.php' );
		wp_localize_script('citiesurl', 'citiesUrl', array( 'citiesUrl' => plugin_dir_url(__FILE__) , )); 
	}
